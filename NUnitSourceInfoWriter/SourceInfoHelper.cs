namespace NUnit.SourceInfoWriter
{
  ...
  public static class SourceInfoHelper
  {
    public static void AddSourceInfoToTestResults(XmlNode testResultsXml)
    {
    ...
    private static bool TryFindSourceLocationForMethod(string assemblyPath, string namespaceName, string typeName, string methodName, out SourceLocation sourceLocation)
    {
